...
function renderProjects() {
    ...
    html += generateProjectCardHTML(projectsData[0]);
    html += generateProjectCardHTML(projectsData[1]);
    html += '</div>';

    html += '<div class="grid md:grid-cols-2 gap-8 mb-8">';
    html += generateProjectCardHTML(projectsData[2]);
    html += generateProjectCardHTML(projectsData[3]);
    html += '</div>';

    html += '<div class="flex justify-center mb-8">';
    html += '<div class="project-card liquid-glass p-6 w-full md:w-1/2">';
    html += generateProjectCardInteriorHTML(projectsData[4]);
    html += '</div></div>';
